...
export const PROFILE_CONTENT = `I am a passionate back end developer and a Masters student at NYU, studying Computer Science with a concentration in Machine Learning and Data Science. With a few years of hands-on experience, I have honed my skills in developing Python scripts to manipulate data, and automate workflow tasks. Currently, I am a DevOps Engineer at CUNY, where I am learning to create custom Chocolatey packages and utilizing my Python skills to automate workflows. My goal is to leverage my expertise to create innovative solutions that drive business growth and deliver exceptional user experiences.`;
